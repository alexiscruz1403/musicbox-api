...
@Module({
  // Los relays de SocialQueueProcessor/ReviewsQueueProcessor publican en
  // NOTIFICATIONS_QUEUE/RECOMMENDATIONS_QUEUE vía PgBossService (@Global) — sin
  // registrar colas por módulo.
